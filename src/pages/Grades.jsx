...
const SUBJECTS = ['Biology', 'Chemistry', 'Physics', 'Mathematics', 'Mathematical Literacy',
  'English', 'Afrikaans', 'isiZulu', 'Life Orientation']
...
export default function Grades() {
  ...
  // Build chart data — one line per subject
  ...
  return (
    <div className="max-w-5xl mx-auto space-y-6">
      ...
      <div className="grid lg:grid-cols-3 gap-6">
        {/* Add grade form */}
        <div className="card">
          <h2 className="font-bold text-gray-900 dark:text-white mb-4">Add Exam Result</h2>
